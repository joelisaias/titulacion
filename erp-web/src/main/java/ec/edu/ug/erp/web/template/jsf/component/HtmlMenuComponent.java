...
public class HtmlMenuComponent extends UIComponentBase {
	...
	public static final String PLACEHOLDER_BUSCAR="Buscar menu";	
	public static final String SEARCH_ICON="fa fa-search";
	...
	public static final String SEARCH_INPUT_CLASS="mediumFont fontSize14 searchInput";
	...
	public static final String DEFAULT_SUBMENU_ICON="fa fa-angle-right";
	...
	public void encodeAll(FacesContext context) throws IOException {
		...
		writer.writeAttribute(HTML_ATTR_CLASS, SEARCH_ICON, null);
		writer.endElement(HTML_I);	
		writer.startElement(HTML_INPUT, this);
		writer.writeAttribute(HTML_ATTR_CLASS, SEARCH_INPUT_CLASS, null);
		writer.writeAttribute(HTML_ATTR_PLACEHOLDER, PLACEHOLDER_BUSCAR, null);
